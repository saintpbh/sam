...
def generate_pony_portrait(character_info, output_path):
    ...
    # Pony Specific Prompting - Compensating for missing LoRA with stronger style tags
    ...
    # Workflow using Pony V6 ONLY (No LoRA) + Ultimate SD Upscale
    workflow = {
        "4": {
            "inputs": {
        ...
        "6": {
            "inputs": {
                ...
                "clip": ["4", 1] # Connected directly to Checkpoint
            },
        ...
        "3": {
            "inputs": {
                ...
                "scheduler": "karras",
                "denoise": 1,
                "model": ["4", 0], # Connected directly to Checkpoint
                "positive": ["6", 0],
                "negative": ["7", 0],
                "latent_image": ["5", 0]
            },
        ...
        "9": {
            "inputs": {
                "filename_prefix": "RTK_Pony_NoLora",
                "images": ["12", 0]
            },
    ...
    print(f"Generating [PONY NO LORA] for {character_name}...")
    try:
...
if __name__ == "__main__":
    ...
    print("\n=== STARTING PRIORITY GENERATION (NO LORA) ===")
