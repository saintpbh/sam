...
# ComfyUI API URL - Using 127.0.0.1 explicitly to avoid localhost issues
...
def generate_pony_portrait(character_info, output_path):
    ...
    # Corrected Node input order and names based on object_info API Check
    workflow = {
        "4": {
            "inputs": {
    ...
    print(f"Generating [FIX PONY V2] for {character_name}...")
    try:
        prompt_res = queue_prompt(workflow)
        # If this fails with 400, it prints error details
...
if __name__ == "__main__":
    ...
    # Priority Characters first to debugging
    ...
    for char_data in characters:
        ...
        if name in priority_list:
            ...
            desc = f"{name} from Romance of the Three Kingdoms"
